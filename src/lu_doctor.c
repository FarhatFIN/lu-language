...
int main(void) {
    LuCase cases[] = {
        ...
        /* v3.0 C-core: multi-dim arrays, casting, printf */
        {
            "multidim_array",
            "Lu/Language\n"
            "#q1\n"
        ...
        /* v3.0 iteration 2: function pointers, unions, pointer arithmetic */
        {
            "function_pointer",
            "Lu/Language\n"
            "def add(int a, int b) -> int { return a + b }\n"
            "def sub(int a, int b) -> int { return a - b }\n"
            "#q1\n"
        ...
        /* v3.0 iteration 3: C++ inheritance, super, virtual dispatch */
        {
            "inheritance_basic",
            "Lu/Language\n"
            "class Animal {\n"
            "  str name\n"
            "  Fn/init(str n):void { Set/this.name = n }\n"
            "  Fn/speak():str { Ret/\"...\" }\n"
            "}\n"
            "class Dog extends Animal {\n"
            "  override Fn/speak():str { Ret/\"Woof\" }\n"
            "}\n"
            "#q1\n"
            "Dog d\n"
            "d.init(\"Rex\")\n"
        ...
        },
        {
            ...
            "Lu/Language\n"
            "class Base {\n"
            "  Fn/greet():str { Ret/\"hello\" }\n"
            "}\n"
            "class Derived extends Base {\n"
            "  override Fn/greet():str { Ret/super.greet() + \"!\" }\n"
            "}\n"
            "#q1\n"
            "Derived d\n"
            "print(d.greet())\n"
        ...
        },
        {
            ...
            "  int w\n"
            "  int h\n"
            "  Fn/init(int ax, int ay, int aw, int ah):void {\n"
            "    Set/this.x = ax\n"
            "    Set/this.y = ay\n"
            "    Set/this.w = aw\n"
            "    Set/this.h = ah\n"
            "  }\n"
            "  override Fn/area():int { Ret/this.w * this.h }\n"
            "}\n"
            "#q1\n"
            "Rect r\n"
            "r.init(0, 0, 5, 4)\n"
        ...
        /* v3.0 iteration 4: operator overloading, lambdas */
        {
            "operator_overload",
            "Lu/Language\n"
            "class Vec2 {\n"
            ...
            "  op+(Vec2 other):Vec2 {\n"
            "    Vec2 result\n"
            "    Set/result.x = this.x + other.x\n"
            "    Set/result.y = this.y + other.y\n"
            "    Ret/result\n"
            "  }\n"
            "}\n"
            "#q1\n"
        ...
        },
        {
            ...
            "Lu/Language\n"
            "#q1\n"
            "fn(int, int) -> int add = fn(int a, int b) -> int { return a + b }\n"
            "print(add(3, 4))\n"
            "fn(int) -> int sq = fn(int x) -> int { return x * x }\n"
            "print(sq(5))\n"
            "#q1:end\n",
            "7\n25\n"
        },
        /* v3.0 iteration 5: Zig features — defer, optionals, error unions */
        {
            "defer_statement",
            "Lu/Language\n"
            "#q1\n"
        ...
        },
        {
            "error_union",
            "Lu/Language\n"
            "def parse_int(str s) -> !int { return atoi(s) }\n"
            "#q1\n"
        ...
        },
        {
            "tagged_union",
            "Lu/Language\n"
            "enum Tag { INT_TAG, FLOAT_TAG, STR_TAG }\n"
            "union Val {\n"
            "  int i\n"
            "  float f\n"
            "  str s\n"
        ...
        /* v3.1: On/ and Spawn/ — real implementation */
        {
            "event_callback",
            "Lu/Language\n"
        ...
        /* v3.2: исправления и новые возможности */

        {
            "fstring_escape",
            "Lu/Language\n"
            "#q1\n"
            "print(f\"literal {{}} stays\")\n"
            "str name = \"Lu\"\n"
            "print(f\"{{hi}} {name}\")\n"
            "#q1:end\n",
            "literal {} stays\n{hi} Lu\n"
        ...
        },
        {
            ...
            "  tensor_set(a, 0, 0, 1)\n"
            "  tensor_set(a, 1, 1, 2)\n"
            "  Tensor e = tensor_eye(2)\n"
            "  Tensor s = tensor_add(a, e)\n"
            "  print(tensor_get(s, 0, 0))\n"
            "  print(tensor_sum(s))\n"
            "  print(tensor_rows(s))\n"
            "  tensor_free(s)\n"
            "  tensor_free(a)\n"
